...
class DeleteTwitchAppidTokensTokenidForm extends React.Component {
  render(){
...
export default reduxForm({
  form: 'deleteTwitchAppidTokensTokenid', // a unique identifier for this form
})(DeleteTwitchAppidTokensTokenidForm);
